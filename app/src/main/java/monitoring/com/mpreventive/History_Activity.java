...
import monitoring.com.mpreventive.adapter.Adapter_History;
import monitoring.com.mpreventive.app.AppController;
import monitoring.com.mpreventive.data.Data_History;

public class History_Activity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {

    FloatingActionButton fab;
    android.support.v7.app.ActionBar actionBar;
    SwipeRefreshLayout swipe;
    List<Data_History> items = new ArrayList<Data_History>();
...
//    String id, no_mesin, nama_mesin, area;
    ...
    public static final String TAG_TANGGAL = "Tgl_inspeksi";
...
//        fab = (FloatingActionButton) findViewById(R.id.fab_add);
        swipe = (SwipeRefreshLayout) findViewById(R.id.swipe_refresh_layout_h);
        ListView listView = (ListView) findViewById(R.id.list_v_history);


        // untuk mengisi data dari JSON ke dalam adapter
        adapter = new Adapter_History(History_Activity.this, items);
...
//        });
        ...
        // listview ditekan lama akan menampilkan dua pilihan
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(final AdapterView<?> parent, View view,
                ...
                dialog = new AlertDialog.Builder(History_Activity.this);
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        switch (which) {
                            case 0:
                                ...
                                Intent intent = new Intent(History_Activity.this, History__Fragment.class);
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        Data_History item = new Data_History();
